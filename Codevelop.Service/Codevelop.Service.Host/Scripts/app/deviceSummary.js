...
(function () {
    ...
    var margin = { top: 30, right: 0, bottom: 100, left: 30 },
        ...
        heaterColours = ["#ffffd9", "#edf8b1", "#fc8f8f", "#ffeda0", "#feb24c", "#f03b20"], 
        times = ["1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a", "11a", "12a", "1p", "2p", "3p", "4p", "5p", "6p", "7p", "8p", "9p", "10p", "11p", "12p"];



    var svg = d3.select("#heaterchart").append("svg")
    ...
    var timeLabels = svg.selectAll(".timeLabel")
        ...
        .attr("transform", "translate(" + ((gridSize / 2)+ 25)   + ", -6)")
    ...
    d3.json('../api/DeviceSummary/Summary?deviceId={0D55E0B7-FF32-41AD-8C02-FAB47C50E62E}&year=2017&month=1', function (data) {
        ...
        var dayLabels = svg.selectAll(".dayLabel")
            ...
            .attr("class", function (d, i) {
                ...
                // 6 = Saturday, 0 = Sunday no good for global but works for NZ :)
                return ((day >= 1 && day <= 5) ? "dayLabel mono axis axis-workweek" : "dayLabel mono axis");
            });
        ...
        entered
            ...
            .style("fill", heaterColours[0]); // start at a light colour, we'll transition them in below
        ...
        legend.append("rect")
            ...
            .style("fill", function (d, i) { return heaterColours[i]; });
